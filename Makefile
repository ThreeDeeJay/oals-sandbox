...
CXXFLAGS = -std=c++11 -Isrc -I../../vorbis/include -I../../ogg/include -I../../openal-soft/include

# linker flags.
LDFLAGS = -L../../vorbis/include/lib64 -LI../../ogg/include/lib64 -L../../openal-soft/lib64 -lopenal32 -logg.dll -lvorbis.dll -lvorbisfile.dll
